...
const translations = {
    ...
    fa: {
        ...
        aboutText1:
            `سلام! من <strong>امیرحسین رنجبر</strong> هستم که با نام <strong>AYG</strong> نیز شناخته می‌شوم. من یک دانش‌آموز ایرانی هستم که در <strong>۲۴ ژوئن ۲۰۱۲</strong> متولد شده‌ام. به فناوری، کامپیوتر، ریاضیات و برنامه‌نویسی علاقه زیادی دارم و از یادگیری چیزهای جدید و به چالش کشیدن خودم لذت می‌برم.`,
